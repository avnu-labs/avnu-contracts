...
from src.adapters.JediSwapAdapter import swap

@external
func __setup__{syscall_ptr: felt*, range_check_ptr, pedersen_ptr: HashBuiltin*}() {
    %{ context.exchange_address = deploy_contract("./tests/mocks/MockJediSwap.cairo").contract_address %}
...
@external
func test__swap__should_call_jediswap{
    ...
    %{ swapExactTokensForTokens_called = expect_call(ids.exchange_address, "swap_exact_tokens_for_tokens", [1, 0, 2, 0, 2, ids.token_from_address, ids.token_to_address, ids.to, 1234]) %}
